...
native_functions = {
  "EO3" : {
    ...
    0x00A1 : Native_Function(0xA1, 0, False, "void", "_set_targeting_1", "sets the targeting scheme to something not standard"),
    0x00A2 : Native_Function(0xA2, 0, False, "void", "_set_targeting_2", "sets the targeting scheme to something not standard"),
    ...
    0x00B4 : Native_Function(0xB4, 1, True, "bool", "_unk_b4", "seems to check a skill id for something"),
    ...
    0x00C3 : Native_Function(0xC3, 1, True, "unknown", "_unk_c3", "no idea"),
